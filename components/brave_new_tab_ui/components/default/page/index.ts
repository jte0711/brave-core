...
export const PosterBackground = styled<ImageLoadProps & HasImageProps, "div">(
  "div"
)`
  position: fixed;
  top: 0;
...
export const IconButtonSideText = styled<IconButtonSideTextProps, "label">(
  "label"
)`
  display: grid;
...
export const IconButtonContainer = styled<IconButtonContainerProps, "div">(
  "div"
)`
